...
class CatalogDialogUi(object):
    def setupUi(self, DockWidget):
        ...
        self.aoi_button = QtGui.QPushButton(self.dockWidgetContents)
        self.aoi_button.setDefault(True)
        self.aoi_button.setObjectName(_fromUtf8("aoi_button"))
        self.button_layout.addWidget(self.aoi_button)
