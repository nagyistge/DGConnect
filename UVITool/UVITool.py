...
from DialogTool import DialogTool
...
class UVITool:
    ...
    def __init__(self, iface):
        ...
        self.dlg = UVIToolDialog(self.iface.mainWindow())
        ...
        self.actions = []
        self.menu = self.tr(u'&UVITool')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'UVITool')
        self.toolbar.setObjectName(u'UVITool')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('UVITool', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/UVITool/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Tool for querying the UVI'),
            callback=self.run,
