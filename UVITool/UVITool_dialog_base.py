...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        self.types_group_box.setMinimumSize(QtCore.QSize(0, 0))
        self.types_group_box.setObjectName(_fromUtf8("types_group_box"))
        self.gridLayout_3 = QtGui.QGridLayout(self.types_group_box)
        ...
        self.gridLayout_3.addWidget(self.types_list_view, 0, 0, 1, 1)
        ...
        self.gridLayout_4 = QtGui.QGridLayout(self.geometry_group_box)
        ...
        self.gridLayout_4.addWidget(self.geometry_list_view, 0, 0, 1, 1)
